...
// isPresent 출석여부
// 화면에 모든 사람을 출력하고
// 출석하면 글자색을 파란색으로 변경한다
// 출석하지 않았다면 글자 크기를 10px
...
//   const attendanceList = attendanceData.map((ppl, i) => {
//     return (
//       <li key={i} style={ppl.isPresent ? {color:"blue"} : {fontSize:"10px"}}>이름: {ppl.name}</li>
//     )
//     // <li key={i} style={{
//     //   color : ppl.isPresent ? "blue" : "black",
//     //   fontSize : ppl.isPresent ? "" : "10px"
//     //   }}>
//     //   {ppl.name}
//     // </li>
//   })
...
const AttendanceContainer = () => {
  ...
  const studentList = attendanceData
    .map((student, i, attendanceData) => (
